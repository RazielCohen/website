...
**P0 · Needs Clarification · Admin dashboard / User management / Public form.** Instructors register on a website, choose a specialty (Firearms/Fitness/Medical), and are individually vetted before approval — including a **questionnaire**: certifying organization (e.g. NRA, USCCA, or similar), average classes taught per month, company website, and similar questions to confirm they run a real organization. **Remaining:** whether the registration site is a separate build (Q-019), the full questionnaire field list and review process (Q-023), whether claimed certifications are actively verified (Q-048), multi-category eligibility (Q-020).
