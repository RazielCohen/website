...
**Top priority: legal counsel review of the minor/children's-program concept (R-006)** before any design or build work touches it. Also receive the client's qualifications/training standards document (Q-002, Q-003, S-011) once available, and resolve the ID-verification vendor scope (Q-025, R-005). In parallel, resolve P0 items: account/auth rules including the serial number vs. login question (Q-005, Q-022), Mid-tier feature list and tier pricing (Q-009, Q-010), the raffle legal/compliance risk (R-001), instructor vetting criteria and downgrade-approval authority (Q-015, Q-021, Q-023), whether instructor registration/vetting is web or in-app (Q-019), and legal review/drafting of both waivers (S-016).
